...
vi.mock('../../src/repositories/user-security-repository', () => ({
...
import {
    ...
    updateUserAvatarKey,
} from '../../src/repositories/user-security-repository';
import { writeUserLogToDB } from '../../src/utils/write-user-log-to-db';
...
const mockedWriteUserLogToDB = vi.mocked(writeUserLogToDB);
...
describe('user-security-service', () => {
    ...
    it('should throw TwofaQrGenerationError when qr code generation fails', async () => {
        ...
        await expect(
            setup2faService({ userId: 7, userName: 'u', ip: null, userAgent: null }, 'a@example.com'),
