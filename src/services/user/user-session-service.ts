...
} from '../../repositories/user/user-session-repository';
...
export const getMySessionsListService = async (
    ...
    try {
        ...
        throw toAppError('userSessionService.getMySessionsList', err);
    }
};
...
export const logoutAllService = async (userId: number): Promise<LogoutAllResult> => {
    try {
        ...
        throw toAppError('userSessionService.logoutAll', err);
    }
};
...
export const logoutDeviceService = async (
    ...
    try {
        ...
        throw toAppError('userSessionService.logoutDevice', err);
    }
};
